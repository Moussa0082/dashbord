...
export const ROUTE: RouteInfo[] = [
  ...
  { path: '/agentTableau', title: 'Tableau de bord',  icon: 'fa-chart-line', class: '' },
...
@Component({
  selector: 'app-agent-side',
  templateUrl: './agent-side.component.html',
  styleUrls: ['./agent-side.component.scss']
})
export class AgentSideComponent implements OnInit {
  menuItems: any[];
